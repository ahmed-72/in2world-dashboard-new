                    ...
                    <div class="col-6">
                        ...
                        <div class="card card-stretch">
                            ...
                            <a href="../../demo9/dist/account/overview.html"
                                ...
                                <!--end::Svg Icon-->
                                <span class="fs-4 fw-bolder">User Profile</span>
                            </a>
                            <!--end::Link-->
                        </div>
                        <!--end::Card-->
                    ...
                    <div class="col-6">
                        ...
                        <div class="card card-stretch">
                            ...
                            <a href="../../demo9/dist/account/statements.html"
                                ...
                                <!--end::Svg Icon-->
                                <span class="fs-4 fw-bolder">Statements</span>
                            </a>
                            <!--end::Link-->
                        </div>
                        <!--end::Card-->
                    ...
                    <div class="col-6">
                        ...
                        <div class="card card-stretch">
                            ...
                            <a href="../../demo9/dist/account/referrals.html"
                                ...
                                <!--end::Svg Icon-->
                                <span class="fs-4 fw-bolder">Best Referrals</span>
                            </a>
                            <!--end::Link-->
                        </div>
                        <!--end::Card-->
                    ...
                    <div class="card-header align-items-center border-0 mt-4">
                        ...
                        <div class="card-toolbar">
                            ...
                            <div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px"
                                data-kt-menu="true" id="kt_menu_61bc5f1b128de">
                                <!--begin::Header-->
                                <div class="px-7 py-5">
                                    ...
                                    <div class="mb-10">
                                        ...
                                        <div>
                                            <select class="form-select form-select-solid"
                                                ...
                                                data-dropdown-parent="#kt_menu_61bc5f1b128de"
                        ...
                        <div class="card card-xl-stretch mb-xl-8">
                            ...
                            <div class="card-body pt-2">
                                ...
                                <div class="d-flex align-items-center mb-8">
                                    ...
                                    <div class="flex-grow-1">
                                        <a href="#"
                                            class="text-gray-800 text-hover-primary fw-bolder fs-6">KPI
                                            App Showcase</a>
                                        <span class="text-muted fw-bold d-block">Due in 2 Days</span>
                                    </div>
                                    <!--end::Description-->
                                ...
                                <div class="d-flex flex-stack">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="d-flex flex-column flex-grow-1 my-lg-0 my-2 pr-3">
                                            <a href="#"
                                                class="text-dark fw-bolder text-hover-primary fs-5">Monthly
                                                Subscription</a>
