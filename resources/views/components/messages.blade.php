<div class="menu-item py-3">
    <a class="menu-link @if(str_contains(URL::current() , 'message')) active @endif" href="{{route('dashboard.messages')}}" title="" data-bs-toggle="tooltip"
        data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right" data-bs-original-title="{{__('Messages')}}">
