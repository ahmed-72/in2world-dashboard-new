...
<div id="kt_header_search" class="d-flex align-items-center" data-kt-search-keypress="true"
    ...
    <form data-kt-search-element="form" class="w-100 position-relative me-3" autocomplete="off">
        ...
        <!--end::Icon-->
        <!--begin::Input-->
        <input type="text" class="form-control custom-form-control ps-13 px-7" name="search" value=""
            placeholder="{{__('Find')}}" data-kt-search-element="input">
        <!--end::Input-->
        <!--begin::Spinner-->
                ...
                <div class="d-flex flex-stack fw-bold mb-5">
                    ...
                    <div class="d-flex" data-kt-search-element="toolbar">
                        ...
                        <div data-kt-search-element="advanced-options-form-show"
                            class="btn btn-icon w-20px btn-sm btn-active-color-primary me-n1" data-bs-toggle="tooltip"
                            title="" data-bs-original-title="Show more search options">
                    ...
                    <span class="svg-icon svg-icon-4x opacity-50">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                            ...
                            <rect x="13.6993" y="13.6656" width="4.42828" height="1.73089" rx="0.865447"
                                transform="rotate(45 13.6993 13.6656)" fill="black"></rect>
                            <path
        ...
        <form data-kt-search-element="advanced-options-form" class="pt-1 d-none">
            ...
            <div class="mb-5">
                <select name="timezone" aria-label="Select a Timezone" data-control="select2"
                    ...
                    data-select2-id="select2-data-1-lp3f" tabindex="-1" aria-hidden="true">
                    <option value="next" data-select2-id="select2-data-3-93va">Within the next</option>
                    <option value="last">Within the last</option>
                    <option value="between">Between</option>
                    <option value="on">On</option>
                </select><span class="select2 select2-container select2-container--bootstrap5" dir="ltr"
                    data-select2-id="select2-data-2-gy9s" style="width: 100%;"><span class="selection"><span
                            class="select2-selection select2-selection--single form-select form-select-sm form-select-solid"
                            role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0"
                            aria-disabled="false" aria-labelledby="select2-timezone-l1-container"
                            aria-controls="select2-timezone-l1-container"><span class="select2-selection__rendered"
                                id="select2-timezone-l1-container" role="textbox" aria-readonly="true"
            ...
            <div class="row mb-8">
                ...
                <div class="col-6">
                    <select name="date_typer" aria-label="Select a Timezone" data-control="select2"
                        ...
                        class="form-select form-select-sm form-select-solid select2-hidden-accessible"
                        data-select2-id="select2-data-4-v317" tabindex="-1" aria-hidden="true">
                        <option value="days" data-select2-id="select2-data-6-k3q3">Days</option>
                        <option value="weeks">Weeks</option>
                        <option value="months">Months</option>
                        <option value="years">Years</option>
                    </select><span class="select2 select2-container select2-container--bootstrap5" dir="ltr"
                        data-select2-id="select2-data-5-w020" style="width: 100%;"><span class="selection"><span
                                class="select2-selection select2-selection--single form-select form-select-sm form-select-solid"
                                role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0"
                                aria-disabled="false" aria-labelledby="select2-date_typer-hg-container"
                                aria-controls="select2-date_typer-hg-container"><span
                                    class="select2-selection__rendered" id="select2-date_typer-hg-container"
            ...
            <div class="d-flex justify-content-end">
                ...
                <a href="../../demo9/dist/pages/search/horizontal.html" class="btn btn-sm fw-bolder btn-primary"
